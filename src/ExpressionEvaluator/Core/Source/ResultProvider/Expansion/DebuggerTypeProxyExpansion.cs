    ...
    internal sealed class DebuggerTypeProxyExpansion : Expansion
    {
            ...
            ResultProvider resultProvider)
        {
            ...
            if (proxyMembers != null)
            {
                ...
                {
                    proxyMemberFullNamePrefix = resultProvider.FullNameProvider.GetClrObjectCreationExpression(inspectionContext, proxyTypeAndInfo.ClrType, proxyTypeAndInfo.Info, new[] { childFullNamePrefix });
                }
