    ...
    internal sealed class ResultsViewExpansion : Expansion
    {
            ...
            IDkmClrFullNameProvider fullNameProvider)
        {
            ...
            var childFullNamePrefix = (fullName == null) ?
                null :
                fullNameProvider.GetClrObjectCreationExpression(inspectionContext, proxyTypeAndInfo.ClrType, proxyTypeAndInfo.Info, new[] { fullName });
            ...
            IDkmClrFullNameProvider fullNameProvider)
        {
            ...
            var childFullNamePrefix = fullNameProvider.GetClrObjectCreationExpression(inspectionContext, _proxyValue.Type, customTypeInfo: null, arguments: new[] { fullName });
            return new EvalResult(
